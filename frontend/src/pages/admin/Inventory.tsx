...
import {
  ...
  RefreshCw, Loader, ChevronDown, ChevronUp, History
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-950 md:ml-64 pt-16 md:pt-0">
      ...
      <div className="border-b border-slate-800 bg-slate-900/50 px-6 py-6">
        ...
        <p className="text-sm text-slate-400 ml-11">Control de stock de productos terminados</p>
      </div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-4">
            <p className="text-xs text-slate-500 uppercase tracking-wider mb-2">Total productos</p>
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-4">
            ...
            <p className={`text-2xl font-bold ${lowStockCount > 0 ? 'text-amber-400' : 'text-slate-500'}`}>{lowStockCount}</p>
          </div>
          <div className="bg-slate-900 border border-slate-800 rounded-xl p-4">
            <p className="text-xs text-slate-500 uppercase tracking-wider mb-2">Agotados</p>
            <p className={`text-2xl font-bold ${outOfStockCount > 0 ? 'text-red-400' : 'text-slate-500'}`}>{outOfStockCount}</p>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-slate-400 font-medium">Sin productos</p>
            <p className="text-sm text-slate-600 mt-1">Agrega productos desde la gestión de sucursales</p>
          </div>
        ) : (
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Ej: Entrega proveedor"
                  className={inputCls}
                />
              </div>
            </div>
